...
export const ChatInputArea = ({
  ...
  // @return
  return <SortableContainer dndKitId="000828bb-3e16-423d-9cb2-36491c6a94ac" containerType="regular" prevTag="div" className="p-6 bg-gradient-to-r from-indigo-50/30 to-purple-50/30 border-t border-white/30" data-magicpath-id="0" data-magicpath-path="ChatInputArea.tsx">
      <SortableContainer dndKitId="14ca6148-3816-4d32-81d0-44771d6e81de" containerType="regular" prevTag="div" className="flex gap-3 items-end" data-magicpath-id="1" data-magicpath-path="ChatInputArea.tsx">
        <SortableContainer dndKitId="b0544a73-eb02-44e2-afba-6081a7f2555f" containerType="regular" prevTag="div" className="flex-1" data-magicpath-id="2" data-magicpath-path="ChatInputArea.tsx">
        ...
        <SortableContainer dndKitId="254bb564-4f5d-4545-9663-f751973f76b9" containerType="regular" prevTag="motion.button" onClick={onSendMessage} disabled={inputText.trim() === '' || isTyping} whileHover={{
        scale: 1.05
      }} whileTap={{
        scale: 0.95
