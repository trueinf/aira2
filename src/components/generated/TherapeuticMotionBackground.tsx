...
export const TherapeuticMotionBackground = () => {
  ...
  return <div className="fixed inset-0 z-0 overflow-hidden">
      ...
      {floatingOrbs.map(orb => <motion.div key={orb.id} className="absolute rounded-full opacity-60 blur-2xl" style={{
      width: orb.size * 1.25,
      ...
      <motion.div className="absolute inset-0 opacity-60" style={{
